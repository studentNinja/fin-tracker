...
const MonthsSpendingsDiagramPart = (props:{spentNumber:number, putAwayNumber:number, income:number }) => {
    ...
    return (
        <div className="months-spendings-diagram-part">
            <div className="block-title">Витрати за місяць
            </div>
            <div className="months-spendings-diagram" id="months-spendings-diagram">
               <div className="pie " style={{ backgroundImage: `conic-gradient(var(--orange-diagram-color) ${spentPercent}%, var(--purple-diagram-color) ${spentPercent}% ${spentPercent+putAwayPercent}%, var(--grey-diagram-color) ${spentPercent+putAwayPercent}%)`
            ...
            <div className="list list-3">
                <div className="list-elem">
                    ...
                    <div className="list-elem-end-block">{props.spentNumber.toLocaleString('uk-UA')}</div>
                </div>
                ...
                <div className="list-elem">
                    ...
                    <div className="list-elem-end-block">{props.putAwayNumber.toLocaleString('uk-UA')}</div>
                </div>
                <div className="list-line"></div>
                <div className="list-elem">
                    <div className="list-elem-start-block">
                    ...
                    <div className="list-elem-end-block">{leftNumber.toLocaleString('uk-UA')}</div>
                </div>
