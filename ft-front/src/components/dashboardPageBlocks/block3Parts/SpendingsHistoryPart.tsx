    ...
    return (
        <div className="spendings-history-part">
            <div className="list-elem-start-block">
                <div className="block-title">Історія витрат
            ...
            <div className="list">
                {props.arraySpendings.map((spending)=> {
                    return <div key={spending.id} style={{display:'flex', gap:'5px', flexDirection:"column"}}>
                        <div className="list-elem">
                            ...
                            <div className="list-elem-end-block">
                                <div className="delete-btn">
                                    <img onClick={()=>props.deleteSpending(spending.id)} src={deleteBtn} alt="delete"/>
                                </div>
