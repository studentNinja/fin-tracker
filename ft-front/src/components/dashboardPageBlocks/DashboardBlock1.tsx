        ...
        <div className="block block-1">
            ...
            <div className="list">
                {arrayIncome.map((income)=> {
                        return <div key={income.id} style={{display:'flex', gap:'5px', flexDirection:"column"}}>
                            <div className="list-elem">
                                ...
                                <div className="list-elem-end-block">
                                    <div className="delete-btn">
                                        <img src={deleteBtn} onClick={()=>props.showConfirmDeletePopUp(()=>deleteIncome(income.id))}
                                             alt="delete"/>
                                    </div>
