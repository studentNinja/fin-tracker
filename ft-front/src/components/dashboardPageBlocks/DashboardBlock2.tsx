...
const DashboardBlock2 = (props: { showMoveMoneyPopUp: (title:string, moveFunct:(number:number)=>void)=>void}) => {
    ...
    function putMoneyAwayToGoal(number:number){
        ...
        if(goalPrevMonthsNumber+goalCurrMonthNumber+number>=goalNumber)
            ...
            setGoalCurrMonthNumber(goalCurrMonthNumber+number)
    ...
    return (
        <div className="block block-2">
            ...
            <div className="goal-buttons-container">
                <div className="btn"
                     onClick={()=>props.showMoveMoneyPopUp("Відкласти кошти", putMoneyAwayToGoal)}
                >Відкласти</div>
                <div className="btn btn-2"
                     onClick={()=>props.showMoveMoneyPopUp("Зняти кошти", getMoneyFromGoal)}
                >Зняти</div>
            </div>
        </div>
